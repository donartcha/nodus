 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Nodus's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Nodus Checkpoint")
		await git.addConfig("user.email", "checkpoint@nodus.bot")
