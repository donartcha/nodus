 ...
 * that data to the shared file-backed stores in ~/.nodus/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.nodus/data/),
 ...
 *   to ~/.nodus/data/ so that tasks created in VSCode are visible in CLI/JetBrains
