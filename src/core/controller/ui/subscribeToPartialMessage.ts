...
import { NodusMessage } from "@shared/proto/nodus/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<NodusMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
export type PartialMessageCallback = (message: NodusMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<NodusMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The NodusMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: NodusMessage): Promise<void> {
