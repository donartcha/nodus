...
export async function regexSearchFiles(
	...
	// Filter results using NodusIgnoreController if provided
	const filteredResults = NodusIgnoreController
		? results.filter((result) => NodusIgnoreController.validateAccess(result.filePath))
		: results
