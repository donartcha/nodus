...
/**
 * Combines sequences of command and command_output messages in an array of nodusMessages.
 *
 * This function processes an array of nodusMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of NodusMessage objects to process.
 * @returns A new array of NodusMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: NodusMessage[]): NodusMessage[] {
	const combinedCommands: NodusMessage[] = []
