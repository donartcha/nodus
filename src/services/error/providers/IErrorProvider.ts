...
import type { NodusError } from "../NodusError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | NodusError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or NodusError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | NodusError, properties?: Record<string, unknown>): void
