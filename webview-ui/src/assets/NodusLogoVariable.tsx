...
/**
 * NodusLogoVariable component renders the Nodus logo with automatic theme adaptation
 ...
 * @returns {JSX.Element} SVG Nodus logo that adapts to VS Code themes and environment
 */
const NodusLogoVariable = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
...
export default NodusLogoVariable
