...
// 'Add to Nodus' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToNodus(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToNodus", request.selectedText, filePath, request.language)
