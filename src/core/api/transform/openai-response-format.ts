...
/**
 * Converts an array of NodusStorageMessage objects (extension of Anthropic format) to a ResponseInput array to use with OpenAI's Responses API.
 *
 ...
 *
 * @param messages - Array of NodusStorageMessage objects to be converted
