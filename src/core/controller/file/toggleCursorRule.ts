import type { ToggleCursorRuleRequest } from "@shared/proto/nodus/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<NodusRulesToggles> {
	...
	return NodusRulesToggles.create({
