 ...
 */
export function useIdleIndicator(scrollContainerRef: React.RefObject<HTMLDivElement>, nodusMessages: NodusMessage[]): boolean {
	...
	useEffect(() => {
		...
		const isTaskComplete = nodusMessages.some(
	...
	}, [scrollContainerRef, nodusMessages])
