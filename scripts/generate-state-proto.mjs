 ...
 *
 * The generated proto content is written to proto/nodus/state.proto,
...
const STATE_PROTO_PATH = "proto/nodus/state.proto"
...
function parseSecretsKeys(sourceFile) {
	...
	for (const element of initializer.getElements()) {
		...
		// Skip prefixed keys like "nodus:nodusAccountId"
		if (!key.includes(":")) {
			keys.push(key)
		}
	}
