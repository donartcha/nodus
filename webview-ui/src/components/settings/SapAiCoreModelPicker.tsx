...
import { SapAiCoreModelDeployment } from "@shared/proto/index.Nodus"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in Nodus
		...
		// Models that are supported in Nodus but NOT deployed
