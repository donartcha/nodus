...
import { NodusIgnoreController } from "./NodusIgnoreController"
import "should"

describe("NodusIgnoreController", () => {
	let tempDir: string
	let controller: NodusIgnoreController
	...
	describe("Error Handling", () => {
		...
		it("should handle missing .Nodusignore gracefully", async () => {
			...
			try {
				const controller = new NodusIgnoreController(emptyDir)
				await controller.initialize()
