 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "Nodus.generatedMachineId"
 ...
 * This is updated to Nodus User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Nodus User ID.
