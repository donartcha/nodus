import type { ToggleAgentsRuleRequest } from "@shared/proto/nodus/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<NodusRulesToggles> {
