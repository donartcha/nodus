...
/**
 * NodusLogoTired component renders the sleepy Nodus logo for "Lazy Teammate Mode".
 *
 * Based on the sleepy-Nodus.svg asset. Features droopy half-closed eyes and a
 ...
 * @returns {JSX.Element} SVG Nodus logo with sleepy/tired expression
 */
const NodusLogoTired = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
