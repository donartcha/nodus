...
export async function refreshWorkflowToggles(
	...
	const globalNodusWorkflowsFilePath = await ensureWorkflowsDirectoryExists()
	const updatedGlobalWorkflowToggles = await synchronizeRuleToggles(globalNodusWorkflowsFilePath, globalWorkflowToggles)
