...
import { OpenAiModelsRequest } from "@shared/proto/nodus/models"
		...
		<div>
			...
			<p
				...
				<span style={{ color: "var(--vscode-errorForeground)" }}>
					(<span style={{ fontWeight: 500 }}>Note:</span> Nodus uses complex prompts and works best with Claude models.
