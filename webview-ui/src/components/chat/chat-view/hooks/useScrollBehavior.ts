...
export function useScrollBehavior(
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<NodusMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: NodusMessage | null = null
