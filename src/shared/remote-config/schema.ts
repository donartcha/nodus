...
// Nodus Provider model schema with per-model settings
export const nodusModelschema = z.object({
	id: z.string(), // The model ID is required
})

// Nodus Provider specific settings
export const NodusSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(nodusModelschema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Nodus: NodusSettingsSchema.optional(),
...
// Settings for a global Nodus rules or workflow file.
