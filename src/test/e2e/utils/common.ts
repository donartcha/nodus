...
export const addSelectedCodeToNodusWebview = async (_page: Page) => {
	...
	const addToNodus = _page.getByText(/Add to Nodus/i)
	await addToNodus.waitFor({ state: "visible" })
