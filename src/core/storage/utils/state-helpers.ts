...
import type { NodusFileStorage } from "@shared/storage/NodusFileStorage"
import {
	applyTransform,
...
import { NodusMemento } from "@/shared/storage"
...
/**
 * Read secrets from a NodusFileStorage instance.
 */
export function readSecretsFromStorage(store: NodusFileStorage<string>): Secrets {
...
/**
 * Read workspace state from a NodusFileStorage instance.
 */
export function readWorkspaceStateFromStorage(store: NodusFileStorage): LocalState {
...
/**
 * Read global state from a NodusFileStorage instance.
 */
export async function readGlobalStateFromStorage(store: NodusMemento): Promise<GlobalStateAndSettings> {
	try {
