...
import type { NodusContent } from "@shared/messages/content"
...
export interface TaskCallbacks {
	...
	sayAndCreateMissingParamError: (toolName: NodusDefaultTool, paramName: string, relPath?: string) => Promise<any>
