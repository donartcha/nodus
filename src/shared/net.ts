 ...
 * ## Proxy Support
 *
 * Nodus uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 * 3. View logs: Check ~/.Nodus/Nodus-core-service.log for network-related
 *    failures.
