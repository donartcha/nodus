import type { OpenRouterModelInfo } from "@shared/proto/nodus/models"
...
export function getNodusUIOnboardingGroups(groupedModels: OnboardingModelGroup): OnboardingModelsByGroup {
