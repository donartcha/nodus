...
import NodusLogoSanta from "@/assets/NodusLogoSanta"
import NodusLogoTired from "@/assets/NodusLogoTired"
...
const HomeHeader = ({ shouldShowQuickWins = false }: HomeHeaderProps) => {
	...
	const LogoComponent = lazyTeammateModeEnabled ? NodusLogoTired : isDecember ? NodusLogoSanta : NodusLogoVariable
