 ...
 * @returns A new array of NodusMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: NodusMessage[]): NodusMessage[] {
