...
import { NodusSyncStorage } from "./NodusStorage"

export interface NodusFileStorageOptions {
	/**
 ...
 */
export class NodusFileStorage<T = any> extends NodusSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "NodusFileStorage", options?: NodusFileStorageOptions) {
		super()
