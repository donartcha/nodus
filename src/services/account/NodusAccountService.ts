...
import { buildBasicNodusHeaders } from "../EnvUtils"

export class NodusAccountService {
	private static instance: NodusAccountService
	...
	/**
	 * Returns the singleton instance of NodusAccountService
	 * @returns Singleton instance of NodusAccountService
	 */
	public static getInstance(): NodusAccountService {
		if (!NodusAccountService.instance) {
			NodusAccountService.instance = new NodusAccountService()
		}
		return NodusAccountService.instance
	}

	/**
	 * Returns the base URL for the Nodus API
	...
	private async authenticatedRequest<T>(
		...
		const NodusAccountAuthToken = options?.authToken ?? (await this._authService.getAuthToken())
