...
import { type NodusToolSpec, resolveInstruction } from "../spec"
...
export class PromptBuilder {
	...
	private static getEnabledTools(variant: PromptVariant, context: SystemPromptContext): NodusToolSpec[] {
		return NodusToolSet.getEnabledToolSpecs(variant, context)
	}
	...
	public static tool(config: NodusToolSpec, registry: NodusDefaultTool[], context: SystemPromptContext): string {
