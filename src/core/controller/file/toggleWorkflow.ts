import { NodusRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/nodus/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<NodusRulesToggles> {
