...
/**
 * Combines API request start and finish messages in an array of nodusMessages.
 *
 ...
 * @returns A new array of NodusMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: NodusMessage[]): NodusMessage[] {
	const combinedApiRequests: NodusMessage[] = []
