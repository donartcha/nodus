...
const createTextMessage = (ts: number, text: string): NodusMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): NodusMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): NodusMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
