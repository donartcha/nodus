...
/**
 * Calculates API metrics from an array of nodusMessages.
 *
 ...
 */
export function getApiMetrics(messages: NodusMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: NodusMessage[]): number {
